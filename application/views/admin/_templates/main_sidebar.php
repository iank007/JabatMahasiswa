...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
						...
						<li class="<?=active_link_controller('organization')?>">
							<a href="<?=site_url('admin/organization/index/'.$user_login['id'])?>">
								<i class="fa fa-user"></i><span>Organization</span></a></li>
                        ...
                        <li class="<?=active_link_controller('users')?>">
							...
							<ul class="treeview-menu">
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>"><?php echo 'Job Desk'; ?></a></li>
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>"><?php echo "Organization's Structure"; ?></a></li>
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>"><?php echo 'Send Invitation'; ?></a></li>
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/prefs/interfaces/admin'); ?>"><?php echo 'Contact'; ?></a></li>
                            </ul>
                        </li>
						<!-- 
